anychart.onDocumentReady(function () {
    ...
    var data = anychart.data.set([
        ...
        ["Zenica", 12, 1, "#fbba09", "#faff00", null, {
            enabled: true
        }],
        ...
        ["Bihać", 8, 1, "#faff00", "#faff00", null, {
            enabled: true
        }],
        ["Srebrenik", 8, 1, "#faff00", "#faff00", null, {
            enabled: true
        }],
        ["Čitluk", 8, 1, "#faff00", "#faff00", null, {
            enabled: true
        }],
        

        ["Sarajevo", 7, 1, "#faff00", "#faff00", null, {
            enabled: true
        }],

        ["Ilidža", 7, 1, "#faff00", "#faff00", null, {
            enabled: true
        }],
        ...
        ["Bijeljina", 5, 1, "#faff00", "#faff00", null, {
            enabled: true
        }],
        ...
        ["Kakanj", 3, 1, "#faff00", "#faff00", null, {
            enabled: true
        }],
        ["Čelinac", 3, 1, "#faff00", "#faff00", null, {
            enabled: true
        }],
        ["Zavidovići", 3, 1, "#faff00", "#faff00", null, {
            enabled: true
        }],
        ...
        ["Novi Travnik", 2, 1, "#faff00", "#faff00", null, {
            enabled: true
        }],
        ...
        ["Vogošća", 1, 1, "#faff00", "#faff00", null, {
            enabled: true
        }],
        ["Cazin", 1, 1, "#faff00", "#faff00", null, {
            enabled: true
        }],
        ["Gornji Vakuf", 1, 1, "#faff00", "#faff00", null, {
            enabled: true
        }],
        ...
        ["Živinice", 1, 1, "#faff00", "#faff00", null, {
            enabled: true
        }],
