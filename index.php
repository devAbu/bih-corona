                ...
                <?php
                   ...
                   // $sql = "SELECT * FROM gradovi";
                    ...
                    <div class="pt-4 center" id="collapse-section">
                        <a data-toggle="collapse" href="#moreCities" role="button" aria-expanded="false"
                            aria-controls="moreCities" id="collapse">
                ...
                <div id="moreCities" class="collapse">
                    <div class="row">
                        ...
                        <div class="center pt-4" id="collapse2-section">
                            <a data-toggle="collapse" href="#moreCities" role="button" aria-expanded="false"
                                aria-controls="moreCities" id="collapse1-extra">
                                <p style="display: inline; color: orangered"> Prikaži manje </p>
                            </a>
                            <a data-toggle="collapse" href="#moreCities2" role="button" aria-expanded="false"
                                aria-controls="moreCities2" id="collapse2">
                ...
                <div id="moreCities2" class="collapse">
                    <div class="row">
                        ...
                        <div class="center pt-4" id="collapse3-section">
                            <a data-toggle="collapse" href="#moreCities2" role="button" aria-expanded="false"
                                aria-controls="moreCities" id="collapse2-extra">
                                <p style="display: inline; color: orangered"> Prikaži manje </p>
                            </a>
                            <a data-toggle="collapse" href="#moreCities3" role="button" aria-expanded="false"
                                aria-controls="moreCities3" id="collapse3">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="center pt-4" id="collapse4-section">
                                <a data-toggle="collapse" href="#moreCities3" role="button" aria-expanded="false"
                                    aria-controls="moreCities3" id="collapse3-extra">
